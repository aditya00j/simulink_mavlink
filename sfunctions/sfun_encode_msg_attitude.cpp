/*
DO NOT EDIT.
This file was automatically created by the Matlab function 'create_sfun_encode' on 15-Nov-2017 16:48:04
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    DTypeId BusType;
	ssRegisterTypeFromNamedObject(S, BUS_NAME_ATTITUDE, &BusType);
	...
	ssSetOutputPortWidth(S, 0, ENCODED_LEN_ATTITUDE);
...
{
	int_T *busInfo = (int_T *) malloc(2*NFIELDS_BUS_ATTITUDE*sizeof(int_T));
    if(busInfo == NULL) {
      ssSetErrorStatus(S, "Memory allocation failure");
      return;
    }
	encode_businfo_attitude(S, busInfo, 0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	encode_vector_attitude(uvec, busInfo, yvec, 0);
}
